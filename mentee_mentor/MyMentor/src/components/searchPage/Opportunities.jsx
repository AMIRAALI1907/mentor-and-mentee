            ...
            <div className="container">
                <div className="row">
                    <difv className="col-md-3 col-12">
                        ...
                        <div className={mobileToggle ? "mt-3 d-none d-sm-block":"mt-3 d-sm-block"}>
                            <div className="form-check ps-0">
                                <label className="form-check-label small " htmlFor="flexCheckDefault">Certificate</label>
                                <input className="form-check-input float-end" value={2} checked={Certificate} onChange={()=>setCertificate((Certificate)=>!Certificate)}    type="checkbox" id="flexCheckDefault"/>
                            </div>
                            ...
                            <div className="form-check ps-0">
                                <label className="form-check-label small " htmlFor="flexCheckDefault">Hiring Possibility</label>
                                <input className="form-check-input float-end" value={0} checked={Availlable} onChange={()=>setAvaillable((Availlable)=>!Availlable)}  type="checkbox" id="flexCheckDefault"/>
                            </div>
                        </div>
                        ...
                        {/* Duration */}
                        <div className={mobileToggle ? "skills mt-5 d-none d-sm-block":"skills mt-5 d-sm-block"}>
                    ...
                    <div className="col-md-9 col-12">
                       <div className='row'>
                            <OpportunitiesFilter locvalue={locvalue} Paid={Paid} Certificate={Certificate} Availlable={Availlable} minValue={minValue} maxValue={maxValue}/>
                       </div>
                    </div>
                </div>
            </div>
